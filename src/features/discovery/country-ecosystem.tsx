...
export function CountryEcosystem({ countryName }: CountryEcosystemProps) {
  return (
      ...
      <main className="flex-1 pt-32 pb-20">
        ...
        <section className="relative mb-20 overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="flex flex-col md:flex-row items-center gap-8 mb-12">
              <div className="h-20 w-20 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-4xl shadow-2xl">
                🇲🇺
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {countryStats.map((stat, i) => (
                <motion.div
                  ...
                  className="glass-surface p-6 rounded-2xl border-white/5"
                >
        ...
        <section className="container mx-auto px-4 md:px-6 mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3].map((item) => (
              <div key={item} className="glass rounded-3xl p-8 border-white/5 group hover:border-primary/30 transition-all">
                <div className="h-12 w-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-lg font-bold text-primary mb-6">
        ...
        <section className="container mx-auto px-4 md:px-6">
          <div className="glass rounded-[32px] p-10 md:p-16 border-white/10 overflow-hidden relative">
